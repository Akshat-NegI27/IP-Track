      ...
      if (isValidUrl) {
        ...
        try {
          ...
          const whoisResponse = await axios.get(
            `https://ameya-apiproxy.vercel.app/api/ip2whois`,
            {
              params: {
          ...
          const domainIpData = {
            ...
            registrar: whoisResponse.data.registrar.name,
            creationDate: whoisResponse.data.create_date,
            updateDate: whoisResponse.data.update_date,
            expireDate: whoisResponse.data.expire_date,
          ...
          <div className="card1">
            <div className="card-body">
              ...
              <div className="css-15x27kp">
                ...
                <ul>
                  <li>
                    <span className="val">{sslData.issuer?.C || "NA"}</span>
                  </li>
                  <li>
                    <span className="val">{sslData.issuer?.O || "NA"}</span>
                  </li>
                  <li>
                    <span className="val">{sslData.issuer?.CN || "NA"}</span>
                  </li>
                </ul>
              </div>
              <div className="css-15x27kp">
              ...
              <div className="css-15x27kp">
                ...
                <span className="val">
                  Expires in {sslData.expiresInDays} days
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="card1">
            <div className="card-body">
              ...
              <div className="css-15x27kp">
                ...
                <span className="val">
                  {domainGeolocation.location?.country || "NA"}
                </span>
              </div>
              <div className="css-15x27kp">
                <span className="lbl">Region</span>
                <span className="val">
                  {domainGeolocation.location?.region || "NA"}
                </span>
              </div>
              <div className="css-15x27kp">
                <span className="lbl">Timezone</span>
                <span className="val">
                  {domainGeolocation.location?.timezone || "NA"}
                </span>
              </div>
              <div className="css-15x27kp">
                ...
                <ul>
                  <li>
                    <span className="val">
                      Latitude: {domainGeolocation.location?.latitude || "NA"}
                    </span>
                  </li>
                  <li>
                    <span className="val">
                      Longitude: {domainGeolocation.location?.longitude || "NA"}
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="css-15x27kp">
                ...
                <ul>
                  {shodanPortData.ports && shodanPortData.ports.length > 0 ? (
                    ...
                    <li>
                      <span className="val">No open ports found</span>
                    </li>
                  )}
                </ul>
              </div>
              ...
              <div className="css-15x27kp">
                ...
                <ul>
                  {shodanPortData.vulns && shodanPortData.vulns.length > 0 ? (
                    ...
                    <li>
                      <span className="val">No Vulnerabilities found</span>
                    </li>
                  )}
                </ul>
              </div>

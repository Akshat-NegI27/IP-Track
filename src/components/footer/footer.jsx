      ...
      <div className="containerx">
        <div className="content_footer">
          <div className="profil">
            ...
            <p>Our mission is to provide innovative solutions and exceptional services to our clients. We strive to achieve excellence in every project we undertake.</p>
            </div>
          ...
          <div className="service_area">
            <ul className="service_header">
              ...
              <li><a href='#'>DNS Domain Check</a></li>
              <li><a href='#'>SSL Certificate Check</a></li>
              <li><a href='#'>CVE Vulnerabilities</a></li>
              <li><a href='#'>Geoloaction Tracker</a></li>
            </ul>
            <ul className="service_header">

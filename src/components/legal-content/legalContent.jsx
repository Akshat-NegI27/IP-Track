    ...
    <div className="legal-container">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to IP Vulnerability Tracker.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to IP Vulnerability Tracker,
            accessible from{" "}
            <a
              href="http://ipvultrack.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              http://ipvultrack.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <Link id="link_Styles1" to={"/Contact"}>
            {" "}
            www.ipvultrack.com/Contact{" "}
          </Link>{" "}
        </li>
      </ul>
    </div>
